...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // LẮNG NGHE TIMEOUT
    sessionConfig.stream.listen((SessionTimeoutState state) {
      ...
      if (context.mounted){
        if (state == SessionTimeoutState.userInactivityTimeout ||
          ...
          _handleSessionTimeout(context, sessionStateStream);
        }
      }
    });
      ...
      child: ChangeNotifierProvider(
        ...
        child: MaterialApp(
          ...
          routes: {
            ...
            '/login': (context) => LoginScreen(onLogin: (user, token) {
  ...
  void _handleSessionTimeout(
    ...
    // Điều hướng về Home nếu không phải Home
